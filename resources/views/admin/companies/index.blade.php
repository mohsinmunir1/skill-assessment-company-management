                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-4">
                        <div class="flex justify-end mt-5">
                            <a class="px-2 py-1 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600" href="{{ route('companies.create') }}"> Create Company</a>
                        </div>
                    </div>
                                    ...
                                    <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        @foreach($companies as $index => $company)
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4">{{$company->website}}</td>
                                                <td class="whitespace-nowrap px-6 py-4">
                                                    <form onsubmit="return confirm('Are you sure want to delete this record?')" action="{{ route('companies.destroy',$company->id) }}" method="POST">

                                                        <a href="{{ route('companies.edit',$company->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
